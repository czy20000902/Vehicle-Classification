...
# net = resnet18(num_classes = 15) #15
net = Full_layer(feature_num=512, class_num=15)
# net = torch.nn.DataParallel(net).cuda()
state_dictBA = torch.load('/home/chenzhaoyang/cls_isda/isda_model/resnet18/fc_state_best.pt')
...
save_path = os.path.join('cls_FC.onnx')
